...
/// </summary>
[UStruct, GeneratedType("FlowSchemaAction_NewSubNode", "UnrealSharp.FlowEditor.FlowSchemaAction_NewSubNode")]
public partial struct FFlowSchemaAction_NewSubNode : MarshalledStruct<FFlowSchemaAction_NewSubNode>
{
    // MenuDescription
    ...
    static int NodeTemplate_Offset;
    /// <summary>
    /// Template of node we want to create
    /// </summary>
    public UnrealSharp.FlowEditor.UFlowGraphNode NodeTemplate;
    ...
    /// parent node
    /// </summary>
    public UnrealSharp.FlowEditor.UFlowGraphNode ParentNode;
    ...
    static FFlowSchemaAction_NewSubNode()
    {
        NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("FlowSchemaAction_NewSubNode");
        ...
        IntPtr NodeTemplate_NativeProperty = FPropertyExporter.CallGetNativePropertyFromName(NativeClassPtr, "NodeTemplate");
        NodeTemplate_Offset = FPropertyExporter.CallGetPropertyOffset(NodeTemplate_NativeProperty);
    ...
    public FFlowSchemaAction_NewSubNode(IntPtr InNativeStruct)
    {
        unsafe
        {
            ...
            NodeTemplate = ObjectMarshaller<UnrealSharp.FlowEditor.UFlowGraphNode>.FromNative(IntPtr.Add(InNativeStruct, NodeTemplate_Offset), 0);
            ParentNode = ObjectMarshaller<UnrealSharp.FlowEditor.UFlowGraphNode>.FromNative(IntPtr.Add(InNativeStruct, ParentNode_Offset), 0);
        }
    }
    
    public static FFlowSchemaAction_NewSubNode FromNative(IntPtr buffer) => new FFlowSchemaAction_NewSubNode(buffer);
    ...
    public void ToNative(IntPtr buffer)
    {
        unsafe
        {
            ...
            ObjectMarshaller<UnrealSharp.FlowEditor.UFlowGraphNode>.ToNative(IntPtr.Add(buffer, NodeTemplate_Offset), 0, NodeTemplate);
            ObjectMarshaller<UnrealSharp.FlowEditor.UFlowGraphNode>.ToNative(IntPtr.Add(buffer, ParentNode_Offset), 0, ParentNode);
        }
    }
}

public static class FFlowSchemaAction_NewSubNodeMarshaller
{
    public static FFlowSchemaAction_NewSubNode FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FFlowSchemaAction_NewSubNode(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FFlowSchemaAction_NewSubNode obj)
    {
    ...
    {
        return FFlowSchemaAction_NewSubNode.NativeDataSize;
    }
}