...
/// </summary>
[UStruct, GeneratedType("FlowGraphSchemaAction_NewNode", "UnrealSharp.FlowEditor.FlowGraphSchemaAction_NewNode")]
public partial struct FFlowGraphSchemaAction_NewNode : MarshalledStruct<FFlowGraphSchemaAction_NewNode>
{
    // MenuDescription
    ...
    static int NodeClass_Offset;
    public TSubclassOf<UnrealSharp.CoreUObject.UObject> NodeClass;
    ...
    static FFlowGraphSchemaAction_NewNode()
    {
        NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("FlowGraphSchemaAction_NewNode");
        ...
        IntPtr NodeClass_NativeProperty = FPropertyExporter.CallGetNativePropertyFromName(NativeClassPtr, "NodeClass");
        NodeClass_Offset = FPropertyExporter.CallGetPropertyOffset(NodeClass_NativeProperty);
        NativeDataSize = UScriptStructExporter.CallGetNativeStructSize(NativeClassPtr);
    }
    
    
    public FFlowGraphSchemaAction_NewNode(IntPtr InNativeStruct)
    {
        unsafe
        {
            ...
            NodeClass = SubclassOfMarshaller<UnrealSharp.CoreUObject.UObject>.FromNative(IntPtr.Add(InNativeStruct, NodeClass_Offset), 0);
        }
    }
    
    public static FFlowGraphSchemaAction_NewNode FromNative(IntPtr buffer) => new FFlowGraphSchemaAction_NewNode(buffer);
    ...
    public void ToNative(IntPtr buffer)
    {
        unsafe
        {
            ...
            SubclassOfMarshaller<UnrealSharp.CoreUObject.UObject>.ToNative(IntPtr.Add(buffer, NodeClass_Offset), 0, NodeClass);
        }
    }
}

public static class FFlowGraphSchemaAction_NewNodeMarshaller
{
    public static FFlowGraphSchemaAction_NewNode FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FFlowGraphSchemaAction_NewNode(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FFlowGraphSchemaAction_NewNode obj)
    {
    ...
    {
        return FFlowGraphSchemaAction_NewNode.NativeDataSize;
    }
}