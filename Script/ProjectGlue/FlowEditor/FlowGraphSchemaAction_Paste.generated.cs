...
/// </summary>
[UStruct, GeneratedType("FlowGraphSchemaAction_Paste", "UnrealSharp.FlowEditor.FlowGraphSchemaAction_Paste")]
public partial struct FFlowGraphSchemaAction_Paste : MarshalledStruct<FFlowGraphSchemaAction_Paste>
{
    // MenuDescription
    ...
    static FFlowGraphSchemaAction_Paste()
    {
        NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("FlowGraphSchemaAction_Paste");
    ...
    public FFlowGraphSchemaAction_Paste(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FFlowGraphSchemaAction_Paste FromNative(IntPtr buffer) => new FFlowGraphSchemaAction_Paste(buffer);
...
public static class FFlowGraphSchemaAction_PasteMarshaller
{
    public static FFlowGraphSchemaAction_Paste FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FFlowGraphSchemaAction_Paste(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FFlowGraphSchemaAction_Paste obj)
    {
    ...
    {
        return FFlowGraphSchemaAction_Paste.NativeDataSize;
    }
}